...
app.drawer = (function(){
	...
	//draw the character
	function drawChar(ctx, frameNum, moveRight, moveLeft, moveUp, moveDown, player, imageArray){
		...
		if(moveRight || (moveRight && moveUp)){
			...
			if(charNum == 15 || charNum == 16){charNum = 14;}
			else if(charNum == 18 || charNum == 19){charNum = 17;}
			else if(charNum == 21 || charNum == 22){charNum = 20;}
			else if(charNum == 24 || charNum == 25){charNum = 23;}
		}
		...
		ctx.drawImage(imageArray[charNum], player.x, player.y, 40, 40);
	}//end draw character
