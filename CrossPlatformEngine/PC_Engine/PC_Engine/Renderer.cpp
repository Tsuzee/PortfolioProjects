...
void Renderer::Draw(float deltaTime, float totalTime)
{
	...
	if (currentScene->opaque.size() > 0)
	{
		...
		{
			currentScene->opaque.at(i)->GetMat()->PrepareMaterial(
				myHelper->Mat4X4ToXMF4X4(myHelper->Transpose(currentScene->opaque.at(i)->GetWorldMat())),
				myHelper->Mat4X4ToXMF4X4(Cam->GetViewMatrix()), 
				myHelper->Mat4X4ToXMF4X4(Cam->GetProjectionMatrix()), 
				vertexShader);
	...
	//	{
	//		currentScene->opaqueNorm.at(i)->GetMat()->PrepareMaterial(myHelper->Mat4X4ToXMF4X4(currentScene->opaqueNorm.at(i)->GetWorldMat()),
	//			myHelper->Mat4X4ToXMF4X4(Cam->GetViewMatrix()), myHelper->Mat4X4ToXMF4X4(Cam->GetProjectionMatrix()), vertexShaderNormalMap);
	...
	//	currentScene->background->GetMat()->PrepareSkybox(myHelper->Mat4X4ToXMF4X4(Cam->GetViewMatrix()), myHelper->Mat4X4ToXMF4X4(Cam->GetProjectionMatrix()), skyVS, skyPS);
	...
	//	{
	//		currentScene->transparentNorm.at(i)->GetMat()->PrepareMaterial(myHelper->Mat4X4ToXMF4X4(currentScene->transparentNorm.at(i)->GetWorldMat()),
	//			myHelper->Mat4X4ToXMF4X4(Cam->GetViewMatrix()),
	//			myHelper->Mat4X4ToXMF4X4(Cam->GetProjectionMatrix()), vertexShaderNormalMap);
	...
	//	{
	//		currentScene->transparent.at(i)->GetMat()->PrepareMaterial(myHelper->Mat4X4ToXMF4X4(currentScene->transparent.at(i)->GetWorldMat()),
	//			myHelper->Mat4X4ToXMF4X4(Cam->GetViewMatrix())
	//			, myHelper->Mat4X4ToXMF4X4(Cam->GetProjectionMatrix()), vertexShader);
...
{
	pShader->SetFloat4("cameraPosition", myHelper->F4ToXMF4(Cam->GetPosition()));
	...
	if (currentScene->spotLights.size() > 0) {
		...
		currentScene->spotLights.at(0)->Position.x = Cam->GetPosition().x;
		currentScene->spotLights.at(0)->Position.y = Cam->GetPosition().y;
		currentScene->spotLights.at(0)->Position.z = Cam->GetPosition().z;
	}
