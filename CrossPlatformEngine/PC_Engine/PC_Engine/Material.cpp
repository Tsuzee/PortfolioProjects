...
//---------------------------------------------------------
// Constructor override to create a material for skybox, particles, and other
// Type 0 = skybox, 1 = particle, 
//---------------------------------------------------------
Material::Material(ID3D11Device* device, ID3D11DeviceContext* context, const wchar_t* path, unsigned int type)
{
	if (type == 0)
	{
...
void Material::SetTexture(ID3D11Device* device, ID3D11DeviceContext* context, const wchar_t* path)
{
	...
	HRESULT hr;
	hr = DirectX::CreateWICTextureFromFile(device, context, path, 0, &SRV);

	device->CreateSamplerState(sampleDes, &sampleState);
}

//---------------------------------------------------------
// Set the material's skybox texture
//---------------------------------------------------------
...
//---------------------------------------------------------
// Set the material's particle texture
//---------------------------------------------------------
...
//---------------------------------------------------------
// Prepare the skybox material for drawing
//---------------------------------------------------------
...
//---------------------------------------------------------
// Return the Rasterrizer Desc for skybox
//---------------------------------------------------------
...
//---------------------------------------------------------
// Return the Depth Stencil for skybox
//---------------------------------------------------------
...
//---------------------------------------------------------
// Return if the material uses transperancy
//---------------------------------------------------------
